            ...
            <form action="{{ url('karyawan/' . $karyawan->id . '/edit') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select required class="form-control" name="role" id="">
                        ...
                        <option value="2" @if (isset($karyawan) && $karyawan->role == '2') selected @endif>Operator</option>
                        <option value="1" @if (isset($karyawan) && $karyawan->role == '1') selected @endif>Admin</option>
                        <option value="3" @if (isset($karyawan) && $karyawan->role == '3') selected @endif>Pengguna</option>
                    </select>
                </div>
